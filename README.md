...
#####               #######                   ######                  ####
### ACOMPANHAMENTO DA LIVE ONDE FOI REALIZADO UM FORK PARA APRENDIZADO ###
### TODOS OS CRÉDITOS SÃO DO AUTOR      """CASSIANO PERES"""    ###
...
Name: Infraestrutura com Serveless
```
```
$ cd Infraestrutura com Serveless
$ code .
``` 
